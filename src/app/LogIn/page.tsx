  ...
  const mutation = useMutation({
    ...
    onSettled: (data, error, variables, context) => {
      ...
      if (data?.status === "Auth failed to Save") {
        ...
        if (responseToken) {
          const decryptePass = decryptedData(data.data.password);
          if (decryptePass !== password) {
            swal({
            ...
            swal("Good job!", "You account has been Logged In", "success");
            router.push("/");
          }
        }
      }
